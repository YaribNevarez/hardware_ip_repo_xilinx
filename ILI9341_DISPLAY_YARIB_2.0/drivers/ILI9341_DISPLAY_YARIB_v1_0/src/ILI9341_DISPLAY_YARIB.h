...
#ifndef ILI9341_DISPLAY_YARIB_H
#define ILI9341_DISPLAY_YARIB_H
...
#define ILI9341_DISPLAY_YARIB_S00_AXI_SLV_REG0_OFFSET 0
#define ILI9341_DISPLAY_YARIB_S00_AXI_SLV_REG1_OFFSET 4
#define ILI9341_DISPLAY_YARIB_S00_AXI_SLV_REG2_OFFSET 8
#define ILI9341_DISPLAY_YARIB_S00_AXI_SLV_REG3_OFFSET 12


/**************************** Type Definitions *****************************/
/**
 *
 * Write a value to a ILI9341_DISPLAY_YARIB register. A 32 bit write is performed.
 * If the component is implemented in a smaller width, only the least
 * significant data is written.
 *
 * @param   BaseAddress is the base address of the ILI9341_DISPLAY_YARIBdevice.
 ...
 * @note
 * C-style signature:
 * 	void ILI9341_DISPLAY_YARIB_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
#define ILI9341_DISPLAY_YARIB_mWriteReg(BaseAddress, RegOffset, Data) \
  	Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))

/**
 *
 * Read a value from a ILI9341_DISPLAY_YARIB register. A 32 bit read is performed.
 * If the component is implemented in a smaller width, only the least
 * significant data is read from the register. The most significant data
 * will be read as 0.
 *
 * @param   BaseAddress is the base address of the ILI9341_DISPLAY_YARIB device.
 * @param   RegOffset is the register offset from the base to write to.
 *
 ...
 * @note
 * C-style signature:
 * 	u32 ILI9341_DISPLAY_YARIB_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
#define ILI9341_DISPLAY_YARIB_mReadReg(BaseAddress, RegOffset) \
 ...
 *
 * @param   baseaddr_p is the base address of the ILI9341_DISPLAY_YARIB instance to be worked on.
 *
 * @return
 *
...
#define TFT_SPI_BASEADDR					XPAR_ILI9341_DISPLAY_YARIB_0_S00_AXI_BASEADDR //Take this addres from "xparameters.h"!
