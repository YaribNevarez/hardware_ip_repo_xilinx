...
HD_PWD='c:/zybo_projects/ip_repo/edit_POXI_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log POXI_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source POXI_v1_0.tcl
